...
int main(int argc, char* argv[])
{
    ...
    fileHandle = CreateFile( "C:/Dev/Pintar/Source/VulkanSimple/Res/vert.spv", GENERIC_READ, 0, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL );
    ...
    fileHandle = CreateFile( "C:/Dev/Pintar/Source/VulkanSimple/Res/frag.spv", GENERIC_READ, 0, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL );
    if( fileHandle == INVALID_HANDLE_VALUE ) {
        OutputDebugStringA( "Failed to open shader file." );
        assert( false, "Failed to open shader file." );
    }
